...
@Component({
  ...
  templateUrl: './relacion-transaccion-depositos.component.html',
  styleUrls: ['./relacion-transaccion-depositos.component.css']
})
export class RelacionTransaccionDepositosComponent implements OnInit {
...
@Component({
  selector: 'app-relacion-transaccion-depositos',
  templateUrl: './dialogRelacion.component.html',
  styleUrls: ['./relacion-transaccion-depositos.component.css']
})
export class DialogRelacion {
